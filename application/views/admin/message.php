              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <strong class="card-title">Mensagem recebida</strong>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="vue-misc">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <h3 class="mb-3"><?php echo $message_item["subject"]; ?></h3>
                          <div class="jumbotron">
                            <?php echo $message_item["message"]; ?>
                          </div>
                          <b><?php echo $message_item["name"]; ?></b>
                            <br>
                            <strong><?php echo $date_formated; ?></strong>
                            <br>
                            <a href="mailto"><?php echo $message_item["email"]; ?></a>
                        </div>
                      </div>
                    </div>
